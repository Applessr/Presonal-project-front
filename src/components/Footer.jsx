...
const Footer = () => {
  return (
    <div className='flex flex-col w-full text-[#22A094] mt-10 bg-[#E2FAF8] '>
    <div className='flex justify-around p-10   items-center mx-24 h-14'>
    <img className='w-40 pt-20' src="https://i.imgur.com/1rQcR3n.png" alt="External Logo" />
