...
const AdminSideBar = () => {
  ...
  return (
    <div className='w-[20%] bg-white text-[#22A094] flex flex-col'>
      ...
      <div className='flex-grow flex flex-col'>
        <div className='flex-grow'>
          <div className='text-lg hover:bg-[#e9e9e9] p-3 pl-10 cursor-pointer' onClick={() => navigate('/admin')}>
            <span className='flex gap-1'>
              <MdDashboardCustomize className='w-8 h-8' /> Dashboard
            </span>
          </div>
          <div className='text-lg hover:bg-[#e9e9e9] p-3 pl-10 cursor-pointer' onClick={() => navigate('/admin/manages')}>
            <span className='flex gap-1'>
              <MdManageAccounts className='w-8 h-8' /> Manage User
            </span>
          </div>
          <div className='text-lg hover:bg-[#e9e9e9] p-3 pl-10 cursor-pointer' onClick={() => navigate('/admin/vocabulary')}>
            <span className='flex gap-1'>
